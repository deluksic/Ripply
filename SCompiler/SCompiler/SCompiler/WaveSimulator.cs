...
namespace WaveSimulation
{
    ...
    class WaveSimulator
    {
        ...
        public RenderTarget2D TargetWrite
        {
            get { return RenderTargets[2]; }
        }
        ...
        {
            graphicsDevice.SetRenderTarget(TargetWrite);
            graphicsDevice.Textures[1] = TargetField;
        ...
        public void EndWrite()
        {
            ...
            graphicsDevice.SetRenderTarget(TargetField);
            spriteBatch.Begin(SpriteSortMode.Immediate, BlendState.Opaque, SamplerState.PointClamp, DepthStencilState.None, RasterizerState.CullNone);
            drawingEffect.CurrentTechnique.Passes[2].Apply();
            spriteBatch.Draw(TargetWrite, new Rectangle(0, 0, TargetWrite.Width, TargetWrite.Height), Color.White);
            spriteBatch.End();
            graphicsDevice.SetRenderTarget(null);
        }
